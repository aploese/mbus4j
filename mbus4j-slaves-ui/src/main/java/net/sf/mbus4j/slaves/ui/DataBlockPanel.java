...
public class DataBlockPanel
    ...
    private void initComponents() {
        ...
        clearActionButton.setFocusPainted(false);
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(exponentTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                                    .addComponent(functionFieldComboBox, 0, 177, Short.MAX_VALUE)
                                    .addComponent(storageNumberTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                                    .addComponent(subunitTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                                    .addComponent(tarifTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                                    .addComponent(dataFieldCodeComboBox, 0, 177, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(vifesLabel)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 544, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(valueTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 780, Short.MAX_VALUE))))
                .addContainerGap())
        );
    ...
    private void clearObjectAction( java.awt.event.ActionEvent evt )
    {//GEN-FIRST:event_clearObjectAction
        objectActionComboBox.setSelectedItem( null );
    }//GEN-LAST:event_clearObjectAction

    private void vifTypeChanged( java.awt.event.ActionEvent evt )
    {//GEN-FIRST:event_vifTypeChanged
    ...
    private DataFieldCode getDataFieldCode() {
        return (DataFieldCode)dataFieldCodeComboBox.getSelectedItem();
    }

    private Vif getVif() {
        return (Vif)vifComboBox.getSelectedItem();
    }

    //TODO
    private VariableLengthType getVariableLengthType() {
        return VariableLengthType.STRING;
    }

    private Vife[] getVifes () {
        Object[] o = vifesList.getSelectedValues();
        Vife[] result = new Vife[o.length];
    ...
    public void commitChanges(UserDataResponse udr, int i)
    {
        DataBlock db = null;
        Class<? extends DataBlock> clazz = DataBlock.getDataBlockClass(getVif(), getVifes(), getDataFieldCode(), getVariableLengthType());
        if (i < udr.getDataBlockCount() ){
            db = udr.getDataBlock(i);
            if (!clazz.equals(db.getClass())) {
                try {
                    db = clazz.newInstance();
            ...
            try {
                ...
                Logger.getLogger(DataBlockPanel.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IllegalAccessException ex) {
                Logger.getLogger(DataBlockPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        db.setVif(getVif());
        db.clearVifes();
        for (Object o : vifesList.getSelectedValues()) {
            db.addVife((Vife)o);
        }
        db.setAction((ObjectAction)objectActionComboBox.getSelectedItem());
        db.setFunctionField((FunctionField)functionFieldComboBox.getSelectedItem());
        db.setStorageNumber(Long.parseLong(storageNumberTextField.getText()));
        db.setDataFieldCode(getDataFieldCode());
        db.setSubUnit(Short.parseShort(subunitTextField.getText()));
        db.setTariff(Integer.parseInt(tarifTextField.getText()));

        db.setValue( valueTextField.getText(  ) );
        udr.replaceDataBlock(udr.getDataBlock(i), db);
    }
}
