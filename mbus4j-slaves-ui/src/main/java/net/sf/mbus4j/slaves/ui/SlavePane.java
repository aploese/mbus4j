 ...
 * SlavePane.java
 *
 * Created on 04.02.2010, 09:43:23
 */
 ...
 * @author aploese
 */
public class SlavePane extends JTabbedPane {
                ...
                .addGroup(deviceDataPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(deviceDataPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(deviceDataPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(accessNumberSpinner, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
                            .addComponent(signatureTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)))
                    .addGroup(deviceDataPanelLayout.createSequentialGroup()
    ...
    private void refreshDeviceData() {
        ...
        versionTextField.setText(String.format("0x%02x", slave.getVersion()));
        identNumberTextField.setText(String.format("%08d", slave.getIdentNumber()));
        addressTextField.setText(String.format("0x%02x", slave.getAddress()));
        accessNumberSpinner.setValue(slave.getAccessnumber());
        signatureTextField.setText(String.format("0x%04x", slave.getSignature()));
    ...
    void commitChanges() {
        slave.setManufacturer(manufacturerTextField.getText());
        slave.setMedium((MBusMedium) mediumComboBox.getSelectedItem());
        slave.setVersion((byte) Integer.parseInt(versionTextField.getText().substring(2), 16));
        slave.setIdentNumber(Integer.parseInt(identNumberTextField.getText()));
        slave.setAddress((byte) Integer.parseInt(addressTextField.getText().substring(2), 16));
        slave.setAccessnumber(((Number) accessNumberSpinner.getValue()).shortValue());
        slave.setSignature((short) Integer.parseInt(signatureTextField.getText().substring(2), 16));
        slave.setAcd(acdCheckBox.isSelected());
        slave.setDfc(dfcCheckBox.isSelected());
        slave.setNetworkSelected(networkSelectedCheckBox.isSelected());
