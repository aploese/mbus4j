...
public class UserDataResponseTest {
    ...
    public void testBCD() throws Exception {
            ...
            ByteDataBlock bdb = new ByteDataBlock(DataFieldCode._2_DIGIT_BCD);
            bdb.setFunctionField(FunctionField.INSTANTANEOUS_VALUE);
            bdb.setVif(VifPrimary.ENERGY_J_E_0);
            bdb.setValue((byte)-1);
            udr.addDataBlock(bdb);
            bdb = new ByteDataBlock(DataFieldCode._2_DIGIT_BCD);
            bdb.setFunctionField(FunctionField.INSTANTANEOUS_VALUE);
            bdb.setVif(VifPrimary.ENERGY_J_E_0);
            bdb.setBcdError("ff");
            udr.addDataBlock(bdb);
            ShortDataBlock sdb = new ShortDataBlock(DataFieldCode._4_DIGIT_BCD);
            ...
            sdb = new ShortDataBlock(DataFieldCode._4_DIGIT_BCD);
            sdb.setFunctionField(FunctionField.INSTANTANEOUS_VALUE);
            sdb.setVif(VifPrimary.ENERGY_J_E_0);
            sdb.setBcdError("ffee");
            udr.addDataBlock(sdb);
            IntegerDataBlock idb = new IntegerDataBlock(DataFieldCode._6_DIGIT_BCD);
            idb.setFunctionField(FunctionField.INSTANTANEOUS_VALUE);
            idb.setVif(VifPrimary.ENERGY_J_E_0);
            idb.setValue(-1);
            udr.addDataBlock(idb);
            idb = new IntegerDataBlock(DataFieldCode._6_DIGIT_BCD);
            idb.setFunctionField(FunctionField.INSTANTANEOUS_VALUE);
            idb.setVif(VifPrimary.ENERGY_J_E_0);
            idb.setBcdError("ffeedd");
            udr.addDataBlock(idb);
            idb = new IntegerDataBlock(DataFieldCode._8_DIGIT_BCD);
            idb.setFunctionField(FunctionField.INSTANTANEOUS_VALUE);
            idb.setVif(VifPrimary.ENERGY_J_E_0);
            idb.setValue(-1);
            udr.addDataBlock(idb);
            ...
            udr.addDataBlock(idb);
            LongDataBlock ldb = new LongDataBlock(DataFieldCode._12_DIGIT_BCD);
            ldb.setFunctionField(FunctionField.INSTANTANEOUS_VALUE);
            ldb.setVif(VifPrimary.ENERGY_J_E_0);
            ldb.setValue(-1);
            udr.addDataBlock(ldb);
            ldb = new LongDataBlock(DataFieldCode._12_DIGIT_BCD);
            ldb.setFunctionField(FunctionField.INSTANTANEOUS_VALUE);
            ldb.setVif(VifPrimary.ENERGY_J_E_0);
